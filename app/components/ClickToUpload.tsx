...
const ClickToUpload: React.FC<props> = ({ handleFileUpload, title, disabled }) => {

    return (
        <div className="File-upload-input">
            <label className="custum-file-upload" htmlFor="fileUpload">
                <div className="icon">
                ...
                <input type="file" accept="image/*" id="fileUpload" onChange={({ target }) => handleFileUpload(target)} disabled={disabled} />
            </label>
        </div>
