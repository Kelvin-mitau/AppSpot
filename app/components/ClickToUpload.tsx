...
const ClickToUpload: React.FC<props> = ({ id, handleFileUpload, title, disabled, acceptedFormat, name }) => {
    return (
        <div className="File-upload-input">
            <label className="custum-file-upload" htmlFor={id}>
                ...
                <input type="file" accept={acceptedFormat} id={id} onChange={({ target }) => handleFileUpload(target)} disabled={disabled} />
            </label>
        </div>
