    ...
    try {
        ...
        body: JSON.stringify(
            { "sender_batch_header": 
                ...
                "items": [ { "recipient_type": "EMAIL", "amount": { "value": price*(1-COMMISSION), "currency": "USD" }, "note": "Thanks for using AppSpot!", "sender_item_id": _id, "receiver": ppEmail, "alternate_notification_method": { "phone": { "country_code": countryCode, "national_number": phoneNumber } }, "notification_language": "en-EN" }] 
            })
        });
